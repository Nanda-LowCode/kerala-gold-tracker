          ...
          <div className="mt-8 grid gap-4">
            {posts.map((post) => (
              <Link
                key={post.slug}
                href={`/blog/${post.slug}`}
                className="group overflow-hidden rounded-2xl border border-zinc-200/70 bg-white shadow-md shadow-amber-100/30 transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-amber-200/40 dark:border-zinc-800/70 dark:bg-zinc-900 dark:shadow-none dark:hover:border-zinc-700"
              >
                {post.coverImage && (
