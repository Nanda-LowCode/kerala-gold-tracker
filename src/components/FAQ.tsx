  ...
  const faqs = [
    {
      ...
      a: `Today's gold rate in ${cityName} is updated daily on this page. We display both 22 Karat (916 purity) and 24 Karat (999 purity) prices per gram and per pavan (8 grams), sourced directly from the Kerala Gold & Silver Merchants Association board rate.`,
    },
    ...(cityData ? [cityData.localMarketFaq] : []),
    ...(cityData ? [cityData.buyingOccasionFaq] : []),
    {
    ...
    },
    {
      ...
      a: "In Kerala, a pavan (also called sovereign) is a traditional unit of gold measurement equal to 8 grams. It is the most common unit used when buying gold jewelry in showrooms across Kerala.",
    },
    {
      q: `What factors influence gold prices in ${cityName}?`,
      a: `Gold prices in ${cityName} are influenced by international gold prices (set in USD on London and New York commodity markets), the USD-INR exchange rate, import duties, 3% GST, and local domestic demand — especially during wedding and festival seasons.`,
    },
    {
      q: "Is this the final price I pay at a jewelry shop?",
      a: "No. The rates shown here are the base Kerala board gold rates. At a jewelry shop, you will additionally pay making charges (varies by design, typically 8–25% of gold value), 3% GST on the total, and hallmarking charges. Always ask for a detailed bill.",
    },
  ];
